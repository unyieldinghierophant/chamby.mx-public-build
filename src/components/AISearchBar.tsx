  ...
  return (
    <form onSubmit={handleSearch} className={className || "w-[70%] mx-auto"}>
      <div className="relative">
        <div className="absolute left-3 md:left-3.5 top-1/2 -translate-y-1/2 flex items-center gap-1 md:gap-2">
        ...
        <Input
          ...
          disabled={isLoading}
          className="pl-10 md:pl-14 pr-28 md:pr-48 h-12 md:h-14 text-sm md:text-base bg-card/95 backdrop-blur-sm border-white/20 shadow-soft hover:shadow-raised transition-all focus:shadow-glow rounded-full"
        />
        <Button
          type="submit"
          disabled={isLoading}
