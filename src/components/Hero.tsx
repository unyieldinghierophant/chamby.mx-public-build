...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-primary flex items-start justify-center pt-4 md:pt-6 overflow-hidden">
      {/* Saved Job Banner */}
      <SavedJobBanner />
      ...
      <div className="w-[96%] md:w-[98%] mx-auto relative z-10 mt-0">
        <div className="text-center space-y-6">
          {/* Hero Content Area */}
          <div className="relative rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden">
            {/* Main Content */}
            <div className="relative z-10 p-6 md:p-8 lg:p-10 xl:p-12 max-w-4xl mx-auto">
              ...
              <div className="space-y-4 md:space-y-6 animate-fade-in">
                <h1 
                  className="font-dillan text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-primary-foreground leading-[1.15] uppercase tracking-wide text-center"
              ...
              <div className="max-w-sm sm:max-w-md md:max-w-xl lg:max-w-2xl mx-auto px-2 sm:px-4 mt-6 md:mt-8">
                ...
                <div className="mt-4">
                  <Link to="/provider-landing">
                    <ModernButton 
                      variant="outline" 
                      className="w-full bg-white/10 text-primary-foreground border-white/25 hover:bg-white/20 hover:border-white/40 flex items-center justify-center gap-2 transition-all duration-300"
                    >
