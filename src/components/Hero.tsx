...
import ParallaxMexicoBackground from "@/components/hero/ParallaxMexicoBackground";
  ...
  return <section className="relative min-h-screen bg-background flex items-start justify-center pt-4 md:pt-6 overflow-hidden">
      ...
      <div className="w-[96%] md:w-[98%] mx-auto relative z-10 mt-0">
        <div className="text-center space-y-6">
          {/* Floating Blue Card Container with Parallax Mexico Background */}
          <div className="relative rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(30,58,138,0.5)] border border-white/10">
            {/* Parallax Mexico map background */}
            <ParallaxMexicoBackground />
            
            {/* Glass card overlay for text readability */}
            ...
            <div className="relative z-10 p-6 md:p-8 lg:p-10 xl:p-12 space-y-6 md:space-y-8">
              {/* Glass card for headline - ensures perfect readability */}
              <div className="backdrop-blur-sm bg-white/10 rounded-2xl p-6 md:p-8 mx-auto max-w-3xl border border-white/20 shadow-lg">
                ...
                {/* Search Bar Section */}
                <div className="max-w-sm sm:max-w-md md:max-w-xl lg:max-w-2xl mx-auto px-2 sm:px-4 mt-6">
