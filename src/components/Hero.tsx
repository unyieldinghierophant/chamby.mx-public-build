        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <Input
              ...
              className="pl-12 sm:pl-14 pr-12 sm:pr-14 py-3 sm:py-4 text-base sm:text-lg bg-white/90 border-gray-300 rounded-2xl focus:ring-primary/50 focus:border-primary/50 backdrop-blur-sm placeholder:text-gray-500 text-gray-900 text-left"
              value={searchQuery}
