        ...
        <div className="relative flex h-16 w-full items-center px-4 md:px-6">
          ...
          <div className="ml-auto flex items-center">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link to="/provider-landing" className="text-primary hover:text-primary/80 transition-colors font-medium">
                Ser Chambynauta
              </Link>
            </div>
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <div className="flex flex-col gap-4 mt-8">
                  ...
                  <Link to="/provider-landing" onClick={() => setMobileMenuOpen(false)} className="px-4 py-2 text-primary hover:text-primary/80 transition-colors font-semibold text-left">
                    Ser Chambynauta
                  </Link>
                </div>
              </SheetContent>
