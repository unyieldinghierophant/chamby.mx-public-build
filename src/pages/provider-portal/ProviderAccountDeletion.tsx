    ...
    <div className="min-h-screen bg-gradient-main bg-gradient-mesh">
      <main className="pt-6 pb-16">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="mb-8">
            <Link
              to="/provider-portal/account"
              className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-4"
            >
              <ArrowLeft className="w-4 h-4" />
              Volver a Mi Cuenta
            </Link>
            <h1 className="text-3xl font-bold text-destructive mb-2">Eliminar Mi Cuenta de Proveedor</h1>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Eliminar tu cuenta de proveedor resultará en la pérdida permanente de tu perfil,
                      verificación, historial de trabajos y ganancias registradas. Esta acción no se
                      puede deshacer bajo ninguna circunstancia.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-center gap-2">
                    ...
                    Tu perfil de proveedor, foto y biografía
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-destructive rounded-full" />
                    Documentos de verificación (INE, selfie, comprobantes)
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-destructive rounded-full" />
                    Historial completo de trabajos y diagnósticos
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-destructive rounded-full" />
                  ...
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-destructive rounded-full" />
                    Conversaciones con clientes y soporte
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-destructive rounded-full" />
                    Conexión con Stripe (tu cuenta de Stripe permanecerá en Stripe)
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-destructive rounded-full" />
                    Zona de servicio, habilidades y configuraciones
                  </li>
                </ul>
              </CardContent>
            </Card>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-medium">Pausar temporalmente</h4>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Deja de recibir trabajos sin perder tu verificación ni tu historial. Contacta a
                      soporte para pausar tu perfil.
                    </p>
                    <Link to="/provider-portal/support" className="mt-2 inline-block">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <Label htmlFor="understand" className="text-sm cursor-pointer">
                      Entiendo que esta acción eliminará permanentemente mi cuenta de proveedor y todos los datos asociados
                    </Label>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <Label htmlFor="dataLoss" className="text-sm cursor-pointer">
                      Acepto que perderé acceso a mi verificación, historial de trabajos, reseñas y ganancias
                    </Label>
                  </div>
...
export default ProviderAccountDeletion;
