...
export default function UserOnboardingWizard() {
  ...
  const handleResendVerification = async (email: string) => {
    ...
    const { error } = await supabase.auth.resend({
      ...
      email: email,
      options: {
        emailRedirectTo: `${window.location.origin}/auth/callback?login_context=client`
      }
    });
      ...
      <div className="min-h-screen bg-primary flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 py-12 text-center md:hidden relative">
          ...
          <p className="text-primary-foreground/80 text-lg mb-10 max-w-xs">
            Encuentra los mejores profesionales para tus servicios del hogar
          </p>
  ...
  // Main wizard layout for steps 2-4
  return (
        ...
        {currentStep >= 2 && currentStep <= 4 && (
          <div className="px-4 pb-4">
            ...
            <div className="relative h-1 bg-muted rounded-full">
              ...
              <div className={cn(
                "absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full transition-colors",
    ...
    return (
      <div className="text-center space-y-6 py-8">
        ...
        <p className="text-muted-foreground text-lg max-w-sm mx-auto">
          Tu cuenta está lista. Ya puedes solicitar servicios.
        </p>
        
        <div className="bg-muted/50 rounded-xl p-5 border max-w-sm mx-auto text-left">
          <h3 className="font-semibold mb-3 text-sm">Tu perfil:</h3>
